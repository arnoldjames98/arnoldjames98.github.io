...
**_James (Updated Response):_** Our updated research question even better leverages my interests and abilities than the first research question. While I still think the focus on biodegradability is positive and useful, I am interested in how to design mechanically intelligent systems. I think that improving on the Klann linkage mechanism by incorporating compliance into the links is an interesting research topic since it has many applications to robotics.
